...
- The desktop layered Home probability field on Draft PR #8 has passed USER visual QA. A subsequent normal-motion review found the prior box float too stop-like and the phase split too aggressive; a smoother continuous float and calmer phase split are now implemented on the same Draft PR, with final-head CI and USER visual acceptance pending.
