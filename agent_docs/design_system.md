...
Mobile remains separately art-directed. The accepted Phase 3 implementation uses a portrait base/overlay and a responsive 44-instance wave field; broad phone and PC visual review passed, the blue/cyan experiment remains rejected, and the original yellow/orange Wave 03 small-wave family, white treatment for the other active mobile wave visuals, desktop-like opacity hierarchy, and doubled thin/dashed small-wave families 03–06 are locked.
